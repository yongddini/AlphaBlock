...
| 항목 | 실측 |
| --- | --- |
| BTC/USDT:USDT 1m 6개월 백필 | 259,201봉 / **67.2s** (259 페이지 × 1000) |
| ETH·SOL 1m (기존 적재) | 각 ≈1,576,900봉 (≈3년, 2023-07-13~) |
| DB 파일 크기(1m 대량 적재 후) | **≈387 MB** (`data/ohlcv.db`) |
| BTC 1m 전체 로드(259k행) | 0.57s / ETH 1m 전체(1.58M행) 3.6s |
| 1m 1일 창(1,440행) 조회 | **6.6ms** |
| 갭 / 중복 | **0 / 0** (전 심볼·TF) |
