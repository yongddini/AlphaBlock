...
> ⚠️ **이 리포트의 성과 수치도 WAN-66로 무효화됐다.** 여기 수치는 익절 목표선이
> EMA `20/60/120/240/365` + VWMA `100`(6선)이던 시절 산출됐는데, 그 6선 익절은
> 사실상 EMA 20에서 조기 익절하는 버그였다(사용자 확정 규칙: 익절선 = EMA 60 +
> VWMA 100). 전/후 재산출은 [`wan66_recompute.md`](wan66_recompute.md) 참고 —
> 익절선을 바로잡으면 평균 익절 거리가 약 1.8배로 벌어지고, 조기 익절로 부풀려졌던
> 승률이 무너져 전략의 음(-)의 엣지가 드러난다.
